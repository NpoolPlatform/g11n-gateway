...
[![Test](https://github.com/NpoolPlatform/g11n-gateway/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/g11n-gateway/actions/workflows/main.yml)
...
* make g11n-gateway ```单独编译服务```
* make g11n-gateway-image ```单独生成服务镜像```
